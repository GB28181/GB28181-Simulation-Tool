...
<html>
  ...
  <body>
	  <div class="sendMsgTitle"><strong>设备信息webService调测</strong></div>
	  </br>
	  <div id="" style="padding:5px;float:left" >
			<form method="post" action="/SIPStandardDebug/WS/deviceInfoResult.jsp" id="deviceInfoSubmit">
				<div id="formItem">
